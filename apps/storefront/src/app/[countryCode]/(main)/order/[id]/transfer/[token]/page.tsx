    ...
    <div className='flex flex-col gap-y-4 items-start w-2/5 mx-auto mt-10 mb-20'>
      ...
      <div className='flex flex-col gap-y-6'>
        ...
        <Text className='text-zinc-600'>
          You&#39;ve received a request to transfer ownership of your order ({id}). If you agree to this request, you can approve the
          transfer by clicking the button below.
        </Text>
