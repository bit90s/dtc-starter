...
const Ideal: React.FC<IconProps> = ({ size: _size = '20', color = 'currentColor', ...attributes }) => {
  return (
    <svg width='24px' height='24px' viewBox='0 0 24 24' role='img' xmlns='http://www.w3.org/2000/svg' fill={color} {...attributes}>
