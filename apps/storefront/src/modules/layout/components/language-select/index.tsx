 ...
 */
const getLocalizedLanguageName = (code: string, fallbackName: string, displayLocale: string = 'en-US'): string => {
  try {
...
const LanguageSelect = ({ toggleState, locales, currentLocale }: LanguageSelectProps) => {
  ...
  return (
    <div>
      <Listbox
        ...
        defaultValue={
          currentLocale ? (options.find((o) => o.code.toLowerCase() === currentLocale.toLowerCase()) ?? DEFAULT_OPTION) : DEFAULT_OPTION
        }
        disabled={isPending}
      >
        ...
        <div className='flex relative w-full min-w-[320px]'>
          <Transition show={state} as={Fragment} leave='transition ease-in duration-150' leaveFrom='opacity-100' leaveTo='opacity-0'>
            <ListboxOptions
