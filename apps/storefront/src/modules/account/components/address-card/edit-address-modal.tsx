...
const EditAddress: React.FC<EditAddressProps> = ({ region, address, isActive = false }) => {
  ...
  return (
    <>
      <div
        className={clx('border rounded-rounded p-5 min-h-[220px] h-full w-full flex flex-col justify-between transition-colors', {
      ...
      >
        ...
        <div className='flex items-center gap-x-4'>
          <button className='text-small-regular text-ui-fg-base flex items-center gap-x-2' onClick={open} data-testid='address-edit-button'>
            <Edit />
            Edit
          </button>
          <button
      ...
      <Modal isOpen={state} close={close} data-testid='edit-address-modal'>
        ...
        <form action={formAction}>
          ...
          <Modal.Body>
            ...
            {formState.error && <div className='text-rose-500 text-small-regular py-2'>{formState.error}</div>}
          </Modal.Body>
          <Modal.Footer>
