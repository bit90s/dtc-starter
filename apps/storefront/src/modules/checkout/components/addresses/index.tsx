...
const Addresses = ({ cart, customer }: { cart: HttpTypes.StoreCart | null; customer: HttpTypes.StoreCustomer | null }) => {
              ...
              <div className='flex items-start gap-x-8'>
                <div className='flex items-start gap-x-1 w-full'>
                  <div className='flex flex-col w-1/3' data-testid='shipping-address-summary'>
                    ...
                    <Text className='txt-medium text-ui-fg-subtle'>{cart.shipping_address.country_code?.toUpperCase()}</Text>
                  </div>
                  ...
                  <div className='flex flex-col w-1/3' data-testid='billing-address-summary'>
                    ...
                    {sameAsBilling ? (
                      ...
                      <>
                        ...
                        <Text className='txt-medium text-ui-fg-subtle'>{cart.billing_address?.country_code?.toUpperCase()}</Text>
                      </>
                    )}
                  </div>
                </div>
