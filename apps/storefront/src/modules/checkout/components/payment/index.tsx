...
const Payment = ({ cart, availablePaymentMethods }: { cart: HttpTypes.StoreCart; availablePaymentMethods: { id: string }[] }) => {
    ...
    <div className='bg-white'>
      ...
      <div>
        <div className={isOpen ? 'block' : 'hidden'}>
          ...
          >
            {!activeSession && isStripeLike(selectedPaymentMethod) ? ' Enter card details' : 'Continue to review'}
          </Button>
        </div>
            ...
            <div className='flex items-start gap-x-1 w-full'>
              ...
              <div className='flex flex-col w-1/3'>
                ...
                <div className='flex gap-2 txt-medium text-ui-fg-subtle items-center' data-testid='payment-details-summary'>
                  ...
                  <Text>{isStripeLike(selectedPaymentMethod) && cardBrand ? cardBrand : 'Another step will appear'}</Text>
                </div>
              </div>
            </div>
          ) : paidByGiftcard ? (
