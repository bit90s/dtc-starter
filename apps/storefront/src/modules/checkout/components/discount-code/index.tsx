          ...
          {isOpen && (
            <>
              <div className='flex w-full gap-x-2'>
                <Input className='size-full' id='promotion-input' name='code' type='text' autoFocus={false} data-testid='discount-input' />
          ...
          <div className='w-full flex items-center'>
            <div className='flex flex-col w-full'>
              ...
              {promotions.map((promotion) => {
                return (
                  <div key={promotion.id} className='flex items-center justify-between w-full max-w-full mb-2' data-testid='discount-row'>
                    <Text className='flex gap-x-1 items-baseline txt-small-plus w-4/5 pr-1'>
                      <span className='truncate' data-testid='discount-code'>
                        <Badge color={promotion.is_automatic ? 'green' : 'grey'}>{promotion.code}</Badge> (
